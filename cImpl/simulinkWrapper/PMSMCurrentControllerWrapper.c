/*
 * File: PMSMCurrentControllerWrapper.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Nov 22 20:27:47 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME PMSMCurrentControllerWrapper
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            5
/* Input Port  0 */
#define IN_PORT_0_NAME        idqRef
...
#define SOURCEFILES           "__SFB__../evcontrol-lib/src/PMSMCurrentController.c__SFB__../evcontrol-lib/src/transforms.c__SFB__../evcontrol-lib/src/pid.c__SFB__../evcontrol-lib/src/sat.c"
#define PANELINDEX            8
...
extern void PMSMCurrentControllerWrapper_Start_wrapper(const real_T *T, const int_T p_width0,
...
extern void PMSMCurrentControllerWrapper_Outputs_wrapper(const real_T *idqRef,
			const real_T *iabc,
			const real_T *theta,
			const real_T *we,
			const real_T *Vdc,
...
static void mdlStart(SimStruct *S)
{
    ...
    const real_T *Kp_id = (const real_T *) mxGetData(PARAM_DEF1(S));
    const real_T *Ki_id = (const real_T *) mxGetData(PARAM_DEF2(S));
    const real_T *Kp_iq = (const real_T *) mxGetData(PARAM_DEF3(S));
    const real_T *Ki_iq = (const real_T *) mxGetData(PARAM_DEF4(S));
    
    PMSMCurrentControllerWrapper_Start_wrapper(T, p_width0, Kp_id, p_width1, Ki_id, p_width2, Kp_iq, p_width3, Ki_iq, p_width4);
}
#endif /*  MDL_START */
...
{
    const real_T *idqRef = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *iabc = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *theta = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *we = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *Vdc = (real_T *) ssGetInputPortRealSignal(S, 4);
    real_T *vdq = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *idq = (real_T *) ssGetOutputPortRealSignal(S, 1);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const int_T   p_width2  = mxGetNumberOfElements(PARAM_DEF2(S));
    const int_T   p_width3  = mxGetNumberOfElements(PARAM_DEF3(S));
    ...
    PMSMCurrentControllerWrapper_Outputs_wrapper(idqRef, iabc, theta, we, Vdc, vdq, idq, T, p_width0, Kp_id, p_width1, Ki_id, p_width2, Kp_iq, p_width3, Ki_iq, p_width4);
